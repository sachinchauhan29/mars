...
const retailerkycstatusView = async (req, res, next) => {
  ...
  res.render('retailerkycstatus', { user: res.userDetail, KYCStatusData, QueryData: req.query, notification: res.notification, startPage, endPage, currentPage, totalRows });
}
